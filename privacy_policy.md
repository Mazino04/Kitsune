...
## Introduction
This Privacy Policy describes how we collect, use, and handle your information when you use Kitsune. We are committed to protecting your privacy and ensuring transparency about our data practices.
...
Firebase Analytics collects anonymous usage data, including country-level geolocation information. This helps us understand how Kitsune is being used across different regions.

### Third-Party Authentication and Integration
Kitsune allows you to authenticate with the following third-party services:
- AniList
- MyAnimeList
...
### Comments System
Our in-house comments API uses your AniList authentication token for verification purposes when you initially open Kitsune. While this token is used for authentication, it is never stored on our servers. We only store:
- Your AniList ID (for authentication)
- Profile picture URL
- Comments you post
- Your up votes on comments
...
- GitHub: [Kitsune Issues](https://github.com/Mazino04/Kitsune/issues)
- Discord: "@mazino04"
- AniList: "mazino04"
